...
public class Items implements ContentList{
    public static Item scrap, copper, lead, graphite, coal, titanium, thorium, concrete, uranium, uranium235, uraniumFuelCell, silicon, plastanium, phasefabric, surgealloy,
    ...
    public void load(){
        ...
        concrete = new Item("concrete", Color.valueOf("97989a")){{
            type = ItemType.material;
        }};

        uranium = new Item("uranium", Color.valueOf("92de8f")){{
            type = ItemType.material;
            explosiveness = 1f;
            hardness = 6;
            radioactivity = 1f;
        ...
        uranium235 = new Item("uranium235", Color.valueOf("1aff1a")){{
            type = ItemType.material;
            explosiveness = 10f;
            radioactivity = 10f;
        }};

        uraniumFuelCell = new Item("uranium-fuel-cell", Color.valueOf("1bff1b")){{
            type = ItemType.material;
            explosiveness = 25f;
            radioactivity = 0.1f;
        }};
