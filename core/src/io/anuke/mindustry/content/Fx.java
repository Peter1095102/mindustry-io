...
public class Fx implements ContentList{
    ...
    unitSpawn, spawnShockwave, magmasmoke, impactShockwave, impactcloud, impactsmoke, dynamicExplosion, dynamicMicroExplosion, dynamicBigExplosion, dynamicSmallExplosion, padlaunch, commandSend, coreLand;
    ...
    public void load(){
        ...
        dynamicMicroExplosion = new Effect(30, e -> {
            float intensity = 1f;
        ...
        dynamicBigExplosion = new Effect(30, e -> {
            float intensity = 10f;
        ...
        dynamicSmallExplosion = new Effect(30, e -> {
            float intensity = 4f;
