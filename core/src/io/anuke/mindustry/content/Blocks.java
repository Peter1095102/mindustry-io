...
public class Blocks implements ContentList{
    ...
    //environment
    air, spawn, deepwater, water, deeplava, taintedWater, tar, stone, craters, charr, sand, darksand, ice, snow, darksandTaintedWater,
    ...
    //crafting
    siliconSmelter, kiln, advancedSiliconSmelter, advancedKiln, graphitePress, concreteMixer, plastaniumCompressor, multiPress, phaseWeaver, surgeSmelter, pyratiteMixer, blastMixer, uraniumEnricher, uraniumCentrifuge, uraniumReprocesser, uraniumProcesser, cryofluidMixer, acidMixer,
    ...
    concreteWall, concreteWallLarge, phaseWall, phaseWallLarge, surgeWall, surgeWallLarge, mender, mendProjector, overdriveProjector, forceProjector, smallForceProjector, shockMine,

    //transport
    conveyor, titaniumConveyor, surgeConveyor, armoredConveyor, distributor, junction, itemBridge, phaseConveyor, sorter, invertedSorter, router, titaniumRouter, surgeRouter, overflowGate, massDriver,
    ...
    //power
    combustionGenerator, thermalGenerator, turbineGenerator, oilGenerator, differentialGenerator, rtgGenerator, solarPanel, largeSolarPanel, thoriumReactor,
    ...
    //storage
    coreShard, coreFoundation, coreNucleus, vault, safe, container, unloader, surgeUnloader, launchPad, launchPadLarge,

    //turrets
    duo, scatter, scorch, hail, arc, wave, lancer, swarmer, salvo, fuse, ripple, nuclearLauncher, cyclone, spectre, meltdown,
    ...
    teslaFactory, fortressFactory, repairPoint,

    //upgrades
    dartPad, deltaPad, sierraPad, kiloPad, tauPad, omegaPad, javelinPad, tridentPad, glaivePad, gammaPad,

    //misc
    fuzzbuckStatue, megaRouter;
    ...
    public void load(){
        ...
        concreteMixer = new GenericSmelter("concrete-mixer"){{
            requirements(Category.crafting, ItemStack.with(Items.copper, 50, Items.lead, 25, Items.silicon, 50, Items.metaglass, 20));
            ...
            consumes.items(new ItemStack(Items.silicon, 1), new ItemStack(Items.sand, 1));
            consumes.liquid(Liquids.water, 0.1f);
            consumes.power(1f);
        }};
        ...
        advancedSiliconSmelter = new GenericSmelter("advanced-silicon-smelter"){{
            requirements(Category.crafting, ItemStack.with(Items.silicon, 100, Items.graphite, 50, Items.metaglass, 25, Items.lead, 50, Items.copper, 150));
            craftEffect = Fx.smeltsmoke;
            ...
            consumes.liquid(Liquids.water, 0.1f);
            consumes.items(new ItemStack(Items.coal, 1), new ItemStack(Items.sand, 3));
            consumes.power(1f);
        }};
        ...
        advancedKiln = new GenericSmelter("advanced-kiln"){{
            requirements(Category.crafting, ItemStack.with(Items.copper, 120, Items.graphite, 60, Items.lead, 60, Items.metaglass, 100, Items.silicon, 30));
            craftEffect = Fx.smeltsmoke;
        ...
        uraniumEnricher = new GenericSmelter("uranium-enricher"){{
            requirements(Category.uranium, ItemStack.with(Items.silicon, 100, Items.lead, 120, Items.thorium, 50, Items.uranium, 25, Items.graphite, 50, Items.metaglass, 200, Items.titanium, 100));
            craftEffect = Fx.smeltsmoke;
            outputItem = new ItemStack(Items.uranium235, 1);
            craftTime = 600f;
            size = 2;
            hasPower = true;
            hasLiquids = true;
            ...
            consumes.power(4f);
            consumes.items(new ItemStack(Items.uranium, 9), new ItemStack(Items.blastCompound, 1), new ItemStack(Items.thorium, 2));

            consumes.liquid(Liquids.acid, 0.1f).boost();
        }};

        uraniumCentrifuge = new GenericSmelter("uranium-centrifuge"){{
            requirements(Category.uranium, ItemStack.with(Items.silicon, 180, Items.concrete, 100, Items.lead, 280, Items.thorium, 100, Items.uranium, 50, Items.graphite, 100, Items.metaglass, 250));
            craftEffect = Fx.smeltsmoke;
            outputItem = new ItemStack(Items.uraniumFuelCell, 1);
            craftTime = 180f;
            size = 4;
            hasPower = true;
            hasLiquids = true;
            ...
            consumes.power(8f);
            consumes.items(new ItemStack(Items.uranium, 1), new ItemStack(Items.uranium235, 9));

            consumes.liquid(Liquids.acid, 0.2f).boost();
        }};

        uraniumReprocesser = new GenericCrafter("uranium-unpacker"){{
            requirements(Category.uranium, ItemStack.with(Items.silicon, 80, Items.lead, 100, Items.uranium, 10, Items.graphite, 70, Items.metaglass, 150));
            craftEffect = Fx.pulverizeRed;
            updateEffect = Fx.pulverize;
            outputItem = new ItemStack(Items.uranium235, 10);
            craftTime = 60f;
            size = 1;
            hasPower = true;
            hasLiquids = true;
            ...
            consumes.power(1.5f);
            consumes.items(new ItemStack(Items.uraniumFuelCell, 1));
        ...
        uraniumProcesser = new GenericCrafter("uranium-packer"){{
            requirements(Category.uranium, ItemStack.with(Items.silicon, 80, Items.lead, 100, Items.uranium, 10, Items.graphite, 100, Items.metaglass, 200));
            craftEffect = Fx.pulverizeRed;
            updateEffect = Fx.pulverize;
            outputItem = new ItemStack(Items.uraniumFuelCell, 1);
            craftTime = 120f;
            ...
            consumes.power(5f);
            consumes.items(new ItemStack(Items.uranium235, 10));
            consumes.liquid(Liquids.water, 0.1f).boost();
        ...
        acidMixer = new LiquidConverter("acidmixer"){{
            requirements(Category.crafting, ItemStack.with(Items.lead, 65, Items.silicon, 40, Items.titanium, 60, Items.metaglass, 50, Items.graphite, 25));
        ...
        message = new MessageBlock("message"){{
            requirements(Category.misc, ItemStack.with(Items.graphite, 5));
        }};
        ...
        concreteWall = new Wall("concrete-wall"){{
            requirements(Category.defense, ItemStack.with(Items.concrete, 6));
            health = 250 * wallHealthMultiplier;
        }};

        concreteWallLarge = new Wall("concrete-wall-large"){{
            requirements(Category.defense, ItemStack.mult(concreteWall.requirements, 4));
        ...
        smallForceProjector = new ForceProjector("micro-force-projector"){{
            requirements(Category.effect, ItemStack.with(Items.lead, 75, Items.silicon, 55, Items.titanium, 25));
            radius=50f;
            cooldownNormal = 1f;
            cooldownLiquid = 0.5f;
            size = 1;
            consumes.item(Items.plastanium).boost();
            consumes.power(1.5f);
        }};
        ...
        surgeConveyor = new Conveyor("surge-conveyor"){{
            requirements(Category.distribution, ItemStack.with(Items.copper, 1, Items.lead, 1, Items.surgealloy, 1));
            health = 100;
            speed = 0.16f;
        }};
        ...
        titaniumRouter = new Router("titanium-router"){{
            requirements(Category.distribution, ItemStack.with(Items.copper, 3, Items.lead, 6, Items.titanium, 6));
            speed = 4f;
        }};

        surgeRouter = new Router("surge-router"){{
            requirements(Category.distribution, ItemStack.with(Items.copper, 3, Items.lead, 6, Items.surgealloy, 6));
            speed = 2f;
        }};
       ...
       oilGenerator = new BurnerGenerator("oil-generator"){{
           requirements(Category.power, ItemStack.with(Items.copper, 150, Items.titanium, 100, Items.lead, 250, Items.silicon, 75, Items.metaglass, 200, Items.graphite, 75));
           hasLiquids = true;
           size = 2;
           powerProduction = 8f;
           itemDuration = 180f;
        ...
        impactReactor = new ImpactReactor("impact-reactor"){{
            requirements(Category.power, ItemStack.with(Items.lead, 500, Items.silicon, 300, Items.graphite, 400, Items.thorium, 100, Items.concrete, 200, Items.surgealloy, 250, Items.metaglass, 250));
            size = 4;
            health = 900;
        ...
        deepDrill = new Drill("deepdrill"){{
            requirements(Category.uranium, ItemStack.with(Items.copper, 500, Items.lead, 300, Items.concrete, 200, Items.silicon, 250, Items.titanium, 225, Items.thorium, 200, Items.surgealloy, 125, Items.phasefabric, 50));
            drillTime = 100;
            size = 4;
            drawRim = true;
            hasPower = true;
            ...
            updateEffect = Fx.pulverizeRed;
            updateEffectChance = 0.03f;
            drillEffect = Fx.magmasmoke;
            rotateSpeed = 120f;
            warmupSpeed = 0.001f;

            consumes.power(8f);
            consumes.liquid(Liquids.acid, 0.12f);
        }};
        ...
        safe = new Vault("safe"){{
            requirements(Category.effect, ItemStack.with(Items.titanium, 500, Items.concrete, 250, Items.uranium, 50, Items.metaglass, 300, Items.silicon, 150));
            health = 3000;
            size = 4;
            itemCapacity = 5000;
        }};
        ...
        surgeUnloader = new Unloader("fast-unloader"){{
            requirements(Category.effect, ItemStack.with(Items.titanium, 55, Items.silicon, 60, Items.surgealloy, 30));
            health = 300;
            speed = 2f;
        }};
        ...
        salvo = new BurstTurret("salvo"){{
            ...
            Items.uranium, Bullets.standardUranium,
            Items.uranium235, Bullets.strongUranium
            );
        ...
        nuclearLauncher = new ArtilleryTurret("nuclear-launcher"){{
            requirements(Category.turret, ItemStack.with(Items.copper, 250, Items.graphite, 150, Items.titanium, 100, Items.concrete, 100, Items.silicon, 150, Items.uranium, 50, Items.uraniumFuelCell, 1));
            ammo(
                    Items.uranium235, Bullets.artilleryUranium,
                    Items.uraniumFuelCell, Bullets.artilleryUraniumCell
            );
            size = 3;
            shots = 1;
            inaccuracy = 12f;
        ...
        teslaFactory = new UnitFactory("tesla-factory"){{
            requirements(Category.units, ItemStack.with(Items.graphite, 75, Items.lead, 100, Items.copper, 125, Items.silicon, 75, Items.metaglass, 50));
            type = UnitTypes.tesla;
            produceTime = 1350;
            size = 2;
            consumes.power(1f);
            consumes.items(new ItemStack(Items.silicon, 8), new ItemStack(Items.metaglass, 12));
        }};
        ...
        kiloPad = new MechPad("kilo-mech-pad"){{
            requirements(Category.upgrade, ItemStack.with(Items.copper, 1000, Items.lead, 750, Items.graphite, 350, Items.silicon, 175));
            mech = Mechs.kilo;
            size = 2;
            consumes.power(1f);
        }};
        ...
        gammaPad = new MechPad("gamma-ship-pad"){{
            requirements(Category.upgrade, ItemStack.with(Items.lead, 255, Items.silicon, 325, Items.concrete, 400, Items.titanium, 400, Items.plastanium, 300, Items.uranium, 100, Items.uraniumFuelCell, 100, Items.graphite, 125));
            mech = Mechs.gamma;
            size = 3;
            consumes.power(4f);
        }};
        ...
        fuzzbuckStatue = new Wall("fuzzbuck-statue"){{
            requirements(Category.misc, ItemStack.with(Items.concrete, 100));
            size = 5;
            health = 1000;
        }};

        megaRouter = new Router("mega-router"){{
            requirements(Category.misc, ItemStack.with(Items.concrete, 150, Items.copper, 300, Items.lead, 600));
            size = 8;
            health = 750;
        }};
    }
