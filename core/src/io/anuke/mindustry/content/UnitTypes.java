...
public class UnitTypes implements ContentList{
    ...
    wraith, ghoul, kamikaze, revenant, lich, uraniumKamikaze, reaper,
    dagger, crawler, titan, tesla, fortress, eruptor, chaosArray, eradicator;
    ...
    public void load(){
        ...
        kamikaze = new UnitType("kamikaze", Ghoul::new){{
            maxVelocity = 1.3f;
            speed = 0.3f;
            drag = 0.2f;
            flying=true;
            ...
            weapon = new Weapon("bomber"){{
                ...
                ejectEffect = Fx.none;
                shootSound = Sounds.explosion;
                bullet = new BombBulletType(4f, 3f, "clear"){
                    {
        ...
        tesla = new UnitType("tesla", Titan::new){{
            maxVelocity = 1f;
            speed = 0.2f;
            drag = 0.3f;
            mass = 3f;
            ...
            weapon = new Weapon("tesla-shockgun"){{
                shake = 2f;
                length = 0.7f;
                reload = 100f;
                shots = 1;
        ...
        uraniumKamikaze = new UnitType("uranium-kamikaze", Ghoul::new){{
            maxVelocity = 1f;
            speed = 0.1f;
            drag = 0.2f;
            flying=true;
            ...
            weapon = new Weapon("bomber"){{
                ...
                ejectEffect = Fx.none;
                shootSound = Sounds.explosion;
                bullet = new BombBulletType(16f, 3f, "clear"){
                    {
                        hitEffect = Fx.dynamicSmallExplosion;
                        lifetime = 30f;
                        speed = 1.1f;
                        splashDamageRadius = 93f;
                        splashDamage = 520f;
                    }
