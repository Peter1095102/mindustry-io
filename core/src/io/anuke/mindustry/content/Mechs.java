...
public class Mechs implements ContentList{
    public static Mech alpha, delta, kilo, tau, omega, dart, javelin, trident, glaive, gamma, sierra;
    ...
    public void load(){
        ...
        gamma = new Mech("gamma-ship", true){
            {
                drillPower = 7;
                mineSpeed = 1.3f;
                speed = 0.52f;
                ...
                health = 500f;
                itemCapacity = 80;
                engineColor = Color.valueOf("71ff6e");
                cellTrnsY = 1f;
                buildPower = 1.8f;

                weapon = new Weapon("uranium-doublegun"){{
                    length = 1.5f;
                    reload = 13f;
                    roundrobin = true;
                    ejectEffect = Fx.shellEjectSmall;
                    bullet = Bullets.standardUranium;
                    shootSound = Sounds.shootSnap;
                }};
            }
        };
        ...
        sierra = new Mech("sierra-mech", false){
            {
                ...
                weapon = new Weapon("cryo-sprayer"){{
                    length = 1f;
                    inaccuracy = 18f;
                    lengthRand = 0.5f;
                    reload = 1.8f;
