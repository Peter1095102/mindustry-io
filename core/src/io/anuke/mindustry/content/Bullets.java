...
public class Bullets implements ContentList{
    ...
    //artillery
    artilleryDense, arilleryPlastic, artilleryPlasticFrag, artilleryHoming, artlleryIncendiary, artilleryExplosive, artilleryUranium, artilleryUraniumCell, artilleryUnit,
    ...
    //standard
    standardCopper, standardDense, standardThorium, standardUranium, strongUranium, mechUranium, standardHoming, standardIncendiary, standardMechSmall,
    ...
    //liquid
    waterShot, cryoShot, slagShot, oilShot, acidShot,
    ...
    public void load(){
        ...
        artilleryUranium = new ArtilleryBulletType(1f, 0, "shell"){{
            hitEffect = Fx.dynamicSmallExplosion;
            shootEffect = Fx.shootBigSmoke2;
            knockback = 5f;
            lifetime = 400f;
            bulletWidth = bulletHeight = 32f;
            collidesTiles = false;
            ammoMultiplier = 1f;
            splashDamageRadius = 100f;
            splashDamage = 150f;
            frontColor = Color.valueOf("92de8f");
            backColor = Color.valueOf("69b766");
        }};

        artilleryUraniumCell = new ArtilleryBulletType(0.5f, 521, "shell"){{
            hitEffect = Fx.dynamicBigExplosion;
            shootEffect = Fx.shootPyraFlame;
            knockback = 50f;
            lifetime = 2000f;
            bulletWidth = bulletHeight = 52f;
            collidesTiles = false;
            ammoMultiplier = 1f;
            splashDamageRadius = 356f;
            splashDamage = 1232f;
            frontColor = Color.valueOf("9cff98");
            backColor = Color.valueOf("69b766");
        }};
        ...
        standardUranium = new BasicBulletType(8f, 71, "bullet"){{
            frontColor = Color.valueOf("92de8f");
            backColor = Color.valueOf("69b766");
            bulletWidth = 5f;
            bulletHeight = 22f;
        ...
        strongUranium = new BasicBulletType(16f, 123, "bullet"){{
            frontColor = Color.valueOf("92de8f");
            backColor = Color.valueOf("69b766");
            bulletWidth = 15f;
            bulletHeight = 43f;
            ...
            hitEffect = Fx.dynamicMicroExplosion;
            ammoMultiplier = 1;
            lifetime = 15f;
        }};

        mechUranium = new BasicBulletType(12f, 32, "bullet"){{
            frontColor = Color.valueOf("71ff6e");
            backColor = Color.valueOf("97ff95");
            bulletWidth = 4f;
            bulletHeight = 16f;
            lifetime = 30f;
            shootEffect = Fx.shootPyraFlame;
