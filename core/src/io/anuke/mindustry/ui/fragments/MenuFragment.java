...
public class MenuFragment extends Fragment{
    ...
    public void build(Group parent){
        ...
        String versionText = "[#fc8140aa]http://mod.mindustry.io";
        ...
        container.table(background, t -> {
            ...
            buttons(t,
                new Buttoni("$play", Icon.play2Small,
                    new Buttoni(Core.bundle.get("campaign.name") + "\n" + Core.bundle.get("campaign.alpha"), Icon.play2Small, ui.deploy::show),
